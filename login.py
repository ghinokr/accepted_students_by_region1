...
with col2:
    st.image('c:/Users/admin/OneDrive/바탕 화면/python/basic program/week10/accepted_students_by_region.png', width=350)

data = pd.read_csv('c:/Users/admin/OneDrive/바탕 화면/python/basic program/week10/members.csv')
# PW를 문자열로 인식!!! 
...
if submit_button:
    if not ID or not PW:
        ...
        if not user.empty:
            ...
            time.sleep(1)
            my_bar.empty()
            #st.switch_page('c:/Users/admin/OneDrive/바탕 화면/python/basic program/week10/pages/bike.py')
